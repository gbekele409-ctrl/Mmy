...
export default function Wallet() {
  ...
  // Bonus and wagering figures come from the user record when the backend
  // provides them; fall back to the flat registration bonus so the UI still
  // renders correctly for a fresh account before those fields exist.
  const bonusBalance = user?.bonus_balance ?? REGISTRATION_BONUS;
